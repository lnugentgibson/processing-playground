...
function setup() {
  ...
  for(i = 0; i < 5; i++) {
    ...
    graph.addEdge(i, 20);
    graph.addEdge(19 - i, 31);
    graph.addEdge(i, 21 + i);
    graph.addEdge(19 - i, 30 - i);
    graph.addEdge(i, 21 + k);
    graph.addEdge(19 - i, 30 - k);
    graph.addEdge(i + 5, 21 + i);
    graph.addEdge(19 - i - 5, 30 - i);
    graph.addEdge(i + 5, 21 + k);
    graph.addEdge(19 - i - 5, 30 - k);
  }
  /*
  for(i = 0; i < 40; i++) {
